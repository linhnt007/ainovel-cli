...
**Trước tiên xem ngân sách số từ mỗi chương**: nếu `working_memory.user_rules.structured.chapter_words` có giá trị, đây không chỉ là ràng buộc viết cho Writer — đây còn là **tham số thiết kế đề cương** — số lượng core_event / scenes mỗi chương có thể chứa phải khớp với khoảng số từ này. Số từ ít (ví dụ 3000/chương) → beat mỗi chương ít hơn, cùng một cung chia thành **nhiều** chương hơn; số từ nhiều (ví dụ 6000/chương) → mỗi chương có thể chứa nhiều cốt truyện hơn, số chương trong cung giảm tương ứng. **Tuyệt đối không nhồi nhét lượng cốt truyện cố định vào bất kỳ số từ nào**: nội dung lẽ ra cần hai chương mà ép vào một chương, sẽ buộc Writer cắt bỏ dẫn dắt và nén cốt truyện (issue #41). Khi chapter_words chưa được thiết lập, lập kế hoạch theo mật độ thông thường của thể loại là được.
