...
- **Biến thiên cú pháp**: Độ dài câu phải dao động — xen kẽ câu ngắn (≤15 từ) với câu dài (30+ từ). Nếu >5 câu liên tiếp cùng độ dài gần bằng nhau hoặc tỷ lệ câu ngắn (≤10 từ) vượt quá 40% tổng câu → đó là vấn đề nhịp điệu, hạ điểm aesthetic. Chương quá ngắn (dưới 1000 từ) mà không có lý do tường thuật chính đáng (chương chuyển tiếp/flashback ngắn được contract chấp nhận) → hạ điểm pacing xuống dưới 60, kích hoạt rewrite.

- **Kỹ thuật tường thuật**: Xử lý thời gian (hồi tưởng/dự thuật/khoảng trống) có tự nhiên không? Nhịp độ phát hành thông tin có hợp lý không (cần giấu thì giấu, cần lộ thì lộ)? Trích dẫn đoạn phát hành thông tin không đúng.
  - **Góc nhìn & thì — đối chiếu hợp đồng tường thuật**: Nếu `working_memory.narrative_contract` tồn tại, đây là chuẩn ngôi kể/thì đã khai ở foundation (pov / pov_characters / tense / notes). Đối chiếu bản gốc với hợp đồng: chương lệch ngôi kể (ví dụ contract khai ngôi 3 hạn tri bám một nhân vật mà chương lại nhảy vào nội tâm nhân vật khác), lệch thì (contract quá khứ mà chương chuyển sang hiện tại), hoặc đổi POV không đúng quy tắc `notes` (ví dụ đổi POV giữa chương khi contract chỉ cho đổi tại ranh giới chương) — đều là **lỗi continuity** (đưa issue vào chiều bốn continuity, không phải aesthetic), **bắt buộc trích dẫn nguyên văn câu/đoạn lệch**. Khi `narrative_contract` **không tồn tại** (foundation cũ chưa khai), quay về tiêu chí mềm: góc nhìn có thống nhất hoặc chuyển đổi có chủ ý không.
